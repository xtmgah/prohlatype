PACKAGES=unix ppx_deriving.std nonstd sosa ocamlgraph cmdliner biocaml.unix hashcons
SETUP_PACKAGE_NAMES=ocamlfind ocamlbuild ppx_deriving.4.1 nonstd.0.0.2 sosa.0.2.0 ocamlgraph.1.8.6 cmdliner.1.0.0 biocaml.0.6.0 hashcons.1.2
